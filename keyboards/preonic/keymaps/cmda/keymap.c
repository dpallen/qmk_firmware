...
[_QWERTY] = {
  ...
  {KC_LSFT,  MOD_HYPR, KC_LGUI, KC_LALT, LOWER,   KC_SPC, KC_SPC, RAISE,   KC_MINUS, KC_EQUAL, KC_LCBR,  KC_RCBR}
},
...
[_LOWER] = {
  ...
  {M(2), KC_BSPC,  KC_UP,   KC_DEL,   KC_WWW_FORWARD, _______, _______, _______, _______,  _______,   KC_LBRC,  KC_RBRC},
  {_______, KC_LEFT,  KC_DOWN, KC_RIGHT, KC_WWW_REFRESH, _______, _______, _______, _______,  _______,   KC_COLN,  KC_PIPE},
  {KC_VOLU, KC_MPRV,  KC_MPLY, KC_MNXT,  KC_WWW_BACK,    _______, _______, _______, _______,  _______,   KC_QUES,  RSFT(KC_ENT)},
